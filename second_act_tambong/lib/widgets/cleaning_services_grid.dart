  ...
  Widget build(BuildContext context) {
    return Column(
      ...
      children: [
        ...
        // Requirement 8: Flexible layout for orientation changes
        // Requirement 10: Grid-like layout using Row and Column (no GridView)
        Column(
          mainAxisSize: MainAxisSize.min,
          children: [
            Flexible(
              ...
              child: Row(
                children: [
                  Expanded(child: ServiceCard(service: _services[0])),
                  const SizedBox(width: 12),
                  Expanded(child: ServiceCard(service: _services[1])),
                ],
              ),
            ),
            const SizedBox(height: 12),
            Flexible(
              ...
              child: Row(
                children: [
                  Expanded(child: ServiceCard(service: _services[2])),
                  const SizedBox(width: 12),
                  Expanded(child: ServiceCard(service: _services[3])),
                ],
              ),
            ),
            const SizedBox(height: 12),
            Flexible(
              ...
              child: Row(
                children: [
                  Expanded(child: ServiceCard(service: _services[4])),
                  const SizedBox(width: 12),
                  Expanded(child: ServiceCard(service: _services[5])),
                ],
              ),
            ),
          ],
