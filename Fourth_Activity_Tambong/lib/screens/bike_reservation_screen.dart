...
// Requirements 1, 4, 8, 9, 10: Form with TextFormField, date/time pickers, text controller, TabBar, and data storage
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        // Requirement 9: TabBar inside AppBar with three tabs
        bottom: TabBar(
      ...
      // Requirement 4: TabBar with TabBarView switching between screens
      body: TabBarView(
        controller: _tabController,
        children: [
          _buildBikesTab(),
