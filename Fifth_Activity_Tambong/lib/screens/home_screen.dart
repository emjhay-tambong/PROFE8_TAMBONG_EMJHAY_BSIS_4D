...
class _HomeScreenState extends State<HomeScreen> {
  ...
  String _currentDrawerPage = 'Home';
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      // Requirement 2: Drawer menu with three different pages
      drawer: Drawer(
        child: ListView(
          ...
          children: [
            ...
            ListTile(
              ...
              selected: _currentDrawerPage == 'Home',
              onTap: () {
                setState(() {
                  _currentDrawerPage = 'Home';
                  _selectedIndex = 0;
                });
            ...
            ListTile(
              ...
              selected: _currentDrawerPage == 'About',
              onTap: () {
                setState(() {
                  _currentDrawerPage = 'About';
                });
                Navigator.pop(context);
            ...
            ListTile(
              ...
              selected: _currentDrawerPage == 'Contact',
              onTap: () {
                setState(() {
                  _currentDrawerPage = 'Contact';
                });
                Navigator.pop(context);
                      ...
                      GridView.count(
                        ...
                        children: [
                          ...
                          _buildModernActionCard(
                            ...
                            onTap: () => Navigator.pushNamed(context, '/media-player'),
                          ),
                          _buildModernActionCard(
                            context,
